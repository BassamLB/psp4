...
const modalConfig = computed<{
    ...
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'تم الآن تفعيل المصادقة الثنائية. امسح رمز الاستجابة السريعة أو أدخل مفتاح الإعداد في تطبيق المصادقة الخاص بك.',
            buttonText: 'إغلاق',
        };
    }
    ...
    if (showVerificationStep.value) {
        return {
            ...
            description: 'أدخل الرمز المكون من 6 أرقام من تطبيق المصادقة الخاص بك',
            buttonText: 'متابعة',
        };
    }
    ...
    return {
        ...
        description:
            'لإكمال التفعيل، امسح رمز الاستجابة السريعة أو أدخل مفتاح الإعداد في تطبيق المصادقة الخاص بك',
        buttonText: 'متابعة',
    };
});
